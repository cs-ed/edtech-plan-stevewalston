...
On the surface, through a course in Computer Science, students will learn problem solving and build the resiliency necessary to tackle future problems.  There is, however, much more to a computer science education that that.  Fields in which computers, technologies and coding are integrated are expanding and will expect an informed and educated labor pool.  With a computer science class as an inroad, students will gain the interest and confidence to pursue further studies and trainings.  Additionally, there will be yet-to-be-created fields that can only be the result of curious and passionate individuals.  With barriers being addressed and removed such as the ongoing efforts to expand high speed internet access, the next innovators may come from anywhere.  Students from rural locations, much like this one, are often myopic regarding career opportunities since they do not see how they can be part of innovative and vibrant economies as those economies are hundreds and hundreds of miles away.

This course will provide an equitable inroad for students at MHS
  * With the only prerequisite that of Tech Essentials so there is no mathematical barrier for enrollment
  * A daily focus on practice and feedback will support students with learning accommodations
  * Opportunities to collaborate with partners and groups provides addtional learning opportunities.  Peer instruction will be fostered and will benefit students of all abilities and further supports English Language Learners and students from under-represented groups.
  * The use of printed materials eases the pressures that students may have in regards to internet access outside of the school day
  * The focus on participation in class activities all but eliminates the pressures students may have in regards to any time they have for homework after school

A future impact is that of building student-driven interest in addtional Computer Science courses.  Interestingly, within the school district, computer programming courses (at non-AP and AP levels) are offered.  Student interest in the courses is typically low.  As students exit this computer science course, they may feel encouraged to enroll in more advanced courses.  Building academic proficieny through multiple years of study could have a positive effect on the choice of and persistence in studying Computer Science related fields after graduation.
