...
It is also worth considering other outcomes of this course, one future impact could be that of building student-driven interest in addtional Computer Science courses.  Within this school district, computer programming courses (at non-AP and AP levels) are offered.  Student interest in the courses is typically low and currently no students at MHS travel to the other campus to take the courses.  As students exit this computer science course, they may feel encouraged to enroll in next-level or advanced courses.  With enough success and interest, programming courses could start up at MHS, creating new opportunities for students to consider or pursue.  Academic proficieny cultivated through multiple years of study would have a positive effect on the choice of and persistence in studying Computer Science related fields after graduation.
