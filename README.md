 ...
 * Exercises
   ...
   * Students submit their answers/results for grading and feedback.  Depending on needs, availability and time, submissions may be done in various manners:
...
In regards to grading, students will earn points(marks) primarily through their efforts during class time.  Specifically:
  ...
  * Score(s) on submitted answers/results.  Recorded by the teacher manually.  The recorded marks will then be combined and entered into the Synergy student information system so students, parents and school staff can see progress and comments.

Embedded in the above plan for daily class meetings, the overarching principle of Content Delivery is that of flexible and clear presentation of information.  Methods and principles to encourage student access to the content are:
...
Some lessons in CodeHS also contain Quizzes and Free-response questions to vary the activities and learning opportunities during class periods.  There is also a customizable feature of CodeHS.com wherein teachers may add extra assignments, of varying types, to any unit through a simple interface.

Another powerful feature of CodeHS.com is that the Checks, Examples and Exercises can either be completed through the CodeHS.com course website digitally or pre-printed for students to complete 'off-line' affording the teacher added flexibility beyond class time.  Specifically, this supports students who miss class due to illness, travel, short-term independent study, etc.

### Impacts

On the surface, through a course in Computer Science, students will learn problem solving, critical thinking skills and to build the resiliency necessary to tackle future problems.  There is, however, much more to an education in computer science education than that.  Fields in which computers, technologies and coding are integrated are expanding and will require an informed and educated labor force.  With a computer science class as an inroad, students will gain the interest and confidence to pursue further studies and trainings.  Additionally, yet-to-be-created fields will emerge and will only be the result of curious and passionate individuals.  With technology related barriers being addressed and removed such as the ongoing efforts to expand high speed internet access, the next innovators may come from anywhere.  Students from rural locations, much like this one, are often myopic regarding career opportunities since they do not see how they can be part of innovative and vibrant economies as those economies are hundreds and hundreds of miles away.  This computer science course is an opportunity to narrow a digital divide.

This course will provide equitable access and a computer science inroad for students at MHS in the following ways:
  * With the only prerequisite that of Tech Essentials there is no mathematical barrier for enrollment
  * The pacing of the course provided through CodeHS provides ample time for students to engage with the content.  Students are not expected to have additional technological skills or fluencies
  * A daily plan centered around practice opportunities with feedback, as well as the inclusion of research-based learning principles will support students with learning accommodations
  * Opportunities to collaborate with partners and groups provide additional learning opportunities.  Peer instruction will be fostered and will benefit students of all abilities.  Collaboration further supports English Language Learners and students from under-represented groups
  * The use of printed materials eases the pressure that students may have in regards to internet access outside of the school day
  * The focus on participation in class activities reduces the pressure students may have in regards to time they may or may not have for homework after school ends
  * If a return to distance education is necessary, the structure of this course may benefit students:
     * Comprised of discrete lessons which are not time intensive, virtual class meetings can be efficient allowing students asynchronous time for additional work
     * Exercises assigned through CodeHS require no additional websites or resources such as cameras to submit answers/work
     * Collaboration will still be supported with the use of breakout rooms

It is also worth considering possible consequences from this course.  One future impact could be that of building student-driven interest in and demand for additional Computer Science courses.  Currently within the school district, computer programming courses (at non-AP and AP levels) are offered at the other comprehensive high school.  Student interest in the courses is typically low and currently no students at MHS travel to the other campus to take the courses.  As students exit this computer science course, they may feel encouraged to enroll in these courses.  With enough student success and interest, programming courses could also be offered here at MHS, creating new opportunities for students to pursue.  New course offerings could also have an effect by reducing the number of students choosing to attend other high schools.  Finally, with the forthcoming changes at Humboldt State, the academic proficiency cultivated through multiple years of course offerings would have a positive effect on the choice of and persistence in studying Computer Science related fields after high school graduation.
